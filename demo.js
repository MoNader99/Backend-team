...
var lyrics1 = new lyrics({
    trackId: track1._id,
    Lyrics: fs.readFileSync("./Lyrics/Hello.txt"),
});
lyrics1.save();

var lyrics2 = new lyrics({
    trackId: track2._id,
    Lyrics: fs.readFileSync("./Lyrics/Lose Yourself.txt"),
});
lyrics2.save();

var lyrics3 = new lyrics({
    trackId: track4._id,
    Lyrics: fs.readFileSync("./Lyrics/When I'm Gone.txt"),
});
lyrics3.save();

var lyrics4 = new lyrics({
    trackId: track6._id,
    Lyrics: fs.readFileSync("./Lyrics/Way Down We Go.txt"),
});
lyrics4.save();

var lyrics5 = new lyrics({
    trackId: track7._id,
    Lyrics: fs.readFileSync("./Lyrics/Broken Bones.txt"),
});
lyrics5.save();

var lyrics6 = new lyrics({
    trackId: track8._id,
    Lyrics: fs.readFileSync("./Lyrics/I Can't Go On Without You.txt"),
});
lyrics6.save();

var lyrics7 = new lyrics({
    trackId: track9._id,
    Lyrics: fs.readFileSync("./Lyrics/Hot Blood.txt"),
});
lyrics7.save();

var lyrics8 = new lyrics({
    trackId: track10._id,
    Lyrics: fs.readFileSync("./Lyrics/SuperLife.txt"),
});
lyrics8.save();

var lyrics9 = new lyrics({
    trackId: track11._id,
    Lyrics: fs.readFileSync("./Lyrics/Let Me Down Slowly.txt"),
});
lyrics9.save();

var lyrics10 = new lyrics({
    trackId: track12._id,
    Lyrics: fs.readFileSync("./Lyrics/BabyShark.txt"),
});
lyrics10.save();

var lyrics11 = new lyrics({
    trackId: track13._id,
    Lyrics: fs.readFileSync("./Lyrics/Focus.txt"),
});
lyrics11.save();

var lyrics12 = new lyrics({
    trackId: track14._id,
    Lyrics: fs.readFileSync("./Lyrics/Believer.txt"),
});
lyrics12.save();

var lyrics13 = new lyrics({
    trackId: track15._id,
    Lyrics: fs.readFileSync("./Lyrics/In The Moment.txt"),
});
lyrics13.save();

var lyrics14 = new lyrics({
    trackId: track16._id,
    Lyrics: fs.readFileSync("./Lyrics/Look At Me Now.txt"),
});
lyrics14.save();

var lyrics15 = new lyrics({
    trackId: track17._id,
    Lyrics: fs.readFileSync("./Lyrics/Devil Eyes.txt"),
});
lyrics15.save();

var lyrics16 = new lyrics({
    trackId: track18._id,
    Lyrics: fs.readFileSync("./Lyrics/Dogs.txt"),
});
lyrics16.save();

var lyrics17 = new lyrics({
    trackId: track19._id,
    Lyrics: fs.readFileSync("./Lyrics/The Blame Game.txt"),
});
lyrics17.save();

var lyrics18 = new lyrics({
    trackId: track20._id,
    Lyrics: fs.readFileSync("./Lyrics/Deus.txt"),
});
lyrics18.save();

var lyrics19 = new lyrics({
    trackId: track22._id,
    Lyrics: fs.readFileSync("./Lyrics/Bohemian Rhapsody.txt"),
});
lyrics19.save();

var lyrics20 = new lyrics({
    trackId: track24._id,
    Lyrics: fs.readFileSync("./Lyrics/Human.txt"),
});
lyrics20.save();

var lyrics21 = new lyrics({
    trackId: track25._id,
    Lyrics: fs.readFileSync("./Lyrics/Skin.txt"),
});
lyrics21.save();

var lyrics22 = new lyrics({
    trackId: track26._id,
    Lyrics: fs.readFileSync("./Lyrics/Dance Monkeys.txt"),
});
lyrics22.save();

var lyrics23 = new lyrics({
    trackId: track27._id,
    Lyrics: fs.readFileSync("./Lyrics/The Kids Are Coming.txt"),
});
lyrics23.save();

var lyrics24 = new lyrics({
    trackId: track28._id,
    Lyrics: fs.readFileSync("./Lyrics/Highest In The Room.txt"),
});
lyrics24.save();

var lyrics25 = new lyrics({
    trackId: track29._id,
    Lyrics: fs.readFileSync("./Lyrics/Don't Let Me Down.txt"),
});
lyrics25.save();

var lyrics26 = new lyrics({
    trackId: track34._id,
    Lyrics: fs.readFileSync("./Lyrics/3500.txt"),
});
lyrics26.save();
...
var user1 = new User({
    ...
    isPremium: true,
    recentlyPlyaedtracks: [track1, track2, track3, track4],
});
